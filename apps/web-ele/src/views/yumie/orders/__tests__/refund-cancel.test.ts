...
describe('canRefundCancel', () => {
  it('hides the refund-cancel action after a rest guest checks out', () => {
    expect(
      canRefundCancel({
  ...
  it('treats the hourly PMS not-confirmed state as checked out', () => {
    expect(
      canRefundCancel({
        checkInDate: '2026-08-20',
        checkinDatetime: '2026-08-19T16:00:00.000Z',
